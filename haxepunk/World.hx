...
class World extends Tweener
{
	...
	/**
	 * Background color of this World. If null, will use HXP.stage.color.
	 * @since	2.6.0
	 */
	...
	/**
	 * Whether or not to track draw calls for this world
	 * @since	4.0.0
	 */
	...
	/**
	 * World-scoped asset cache. These assets will be destroyed when the world
	 * ends.
	 */
	 ...
	 * rendering this world. GL targets (desktop, mobile, HTML5) only.
	 *
	 * @since	4.0.0
	 */
	...
	/**
	 * Invoked after this World's update cycle.
	 */
	public var postUpdate:Signal0 = new Signal0();
	/**
	 * Invoked before rendering begins for this World each frame.
	 */
	public var preRender:Signal0 = new Signal0();
	/**
	 * Invoked after rendering this World completes.
	 */
	public var postRender:Signal0 = new Signal0();
	/**
	 * Invoked after this World is resized.
	 */
	public var onResize:Signal0 = new Signal0();
	/**
	 * Invoked when input is received while this World is active.
	 */
	...
	/**
	 * Override this; called when World is switched to for the first time.
	 */
	public function begin() {}

	/**
	 * Override this; called when this World is switched to after it has already begun.
	 */
	...
	/**
	 * Pushes all Entities in the World of the type into the Array or Vector. This
	 * function does not empty the array, that responsibility is left to the user.
	 * @param	type		The type to check.
	...
	/**
	 * Pushes all Entities in the World of the Class into the Array or Vector. This
	 * function does not empty the array, that responsibility is left to the user.
	 * @param	c			The Class type to check.
	 * @param	into		The Array or Vector to populate.
	 */
	...
	/**
	 * Pushes all Entities in the World on the layer into the Array or Vector. This
	 * function does not empty the array, that responsibility is left to the user.
	 * @param	layer		The layer to check.
	 * @param	into		The Array or Vector to populate.
	 */
	...
	/**
	 * Pushes all Entities in the World into the array. This
	 * function does not empty the array, that responsibility is left to the user.
	 * @param	into		The Array or Vector to populate.
	 */
	 ...
	 * @param	shouldAdd	If new Entities should be added to the world.
	 */
